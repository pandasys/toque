...
package com.ealva.toque.android.service.scrobble
...
class ScrobblerFacadeTest {
  ...
  @Test
  fun testScrobble() = coroutineRule.runBlockingTest {
    val item = PlayableAudioItemFake()
  ...
  @Test
  fun testScrobblerPrefChange() = coroutineRule.runBlockingTest {
    val item = PlayableAudioItemFake()
  ...
  @Test
  fun testSetSameScrobblerPackageDoesNotFlowDuplicate() = coroutineRule.runBlockingTest {
    val item = PlayableAudioItemFake()
    val scrobbler1 = ScrobblerStub()
    val scrobbler2 = ScrobblerStub()
    val factory = ScrobblerFactoryStub()
