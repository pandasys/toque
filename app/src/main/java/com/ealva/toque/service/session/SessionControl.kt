...
interface SessionControl {
  ...
  /**
   * Request that the player prepare playback for a specific media id. This can decrease the time it
   ...
   * time it takes to start playback when a play command is received. An empty or null query should
...
//   * @param action The action identifier of the [PlaybackStateCompat.CustomAction] as specified by
//   * the [MediaSessionCompat].
//   * @param args Optional arguments to supply to the [MediaSessionCompat] for this custom action.
//   */
